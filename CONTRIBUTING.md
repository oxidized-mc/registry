# Contributing to oxidized-registry
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/registry.git
cd registry
...
`oxidized-registry` is a library crate in the
...
Use `registry` as the scope for all changes to this crate.
